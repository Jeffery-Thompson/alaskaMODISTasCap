...
# 8 clusters seems about where the information starts to become less useful    
gaussMix8cl = GaussianMixture(n_components=8,covariance_type='full',
                               max_iter=100,verbose=False,init_params='kmeans',
                               random_state=42)
clusterFit= gaussMix8cl.fit(dataClst)
clMems = gaussMix8cl.predict(dataClst)
